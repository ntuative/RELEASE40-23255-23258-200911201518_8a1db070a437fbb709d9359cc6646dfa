package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_136 = new ByteArray();
         var_56 = 0;
         while(var_56 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_56++;
            var_136[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_136[_loc4_ = var_56++] = _loc2_ & 255;
         }
         var_56 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_56++;
         var_136[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_56++;
         var_136[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_136[_loc4_ = var_56++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_136[_loc5_ = var_56++] = 0 ^ param1 >> 24 & 255;
         var_56 %= psize;
         var_1935 = true;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_136[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_136.length = 0;
         var_136 = null;
