package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_835:RoomObjectLocationCache;
      ...
      private var var_2071:Number = -10000000;
      
      private var var_2072:Number = -10000000;
      ...
      private var var_1006:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_835 = new RoomObjectLocationCache(_loc6_);
         var_300 = new Map();
      ...
      public function update() : void
      {
         if(var_1004 == 0)
         {
            checkMouseHits(var_1005.x,var_1005.y,MouseEvent.MOUSE_MOVE);
         }
         var_1004 = 0;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_270 != null)
         {
            var_270.graphics.clear();
         }
         else
         {
            var_270 = new Sprite();
            var_270.name = "mask";
            _master.addChild(var_270);
         }
         var_270.graphics.beginFill(0);
         var_270.graphics.drawRect(0,0,param1,param2);
         var_1003 = param1;
         var_1007 = param2;
      ...
      {
         var _loc11_:Number = param1 - var_1003 / 2;
         var _loc12_:Number = param2 - var_1007 / 2;
         var _loc13_:* = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_479.length)
            {
               cleanSprite(var_479[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_479 = [];
         }
         ...
         while(_loc1_ < var_300.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1006 != null)
                  {
                     var_1006.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1478,geometry);
                  }
                  else
                  {
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_480.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_480.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2071 || param2 != var_2072)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_480.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_480.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_479.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_835.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_1003 / 2);
         _loc8_ += int(var_1007 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_1003 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_1007))
                     {
