package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_517:Number = 64;
      
      public static const const_979:Number = 32;
      ...
      private var var_1378:Number = 1;
      
      private var var_2206:Number = 500;
      
      private var var_1377:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_88 = new Vector3d();
         var_941 = new Vector3d();
         var_1376 = 1;
         var_1377 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1378 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_376 != param1 * var_1378)
         {
            var_376 = param1 * var_1378;
            ++var_82;
         }
      }
      ...
      {
         if(var_375 != param1 * var_1376)
         {
            var_375 = param1 * var_1376;
            ++var_82;
         }
      }
      ...
      {
         if(var_377 != param1 * var_1377)
         {
            var_377 = param1 * var_1377;
            ++var_82;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_378 != null)
         {
            ...
            var_378.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_378.add(_loc3_,_loc4_);
            ++var_82;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_941.assign(_loc22_);
         }
         else
         {
            var_941.assign(_loc17_);
         }
         ++var_82;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_377;
         _loc2_.z *= var_376;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_941);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_377;
            _loc2_.z *= var_376;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_941);
         }
      ...
      {
         return new Vector3d(0 * var_375,0 * var_377,0 * var_376);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_378 != null)
         {
            ...
            return var_378.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_375,0 * var_377,0 * var_376);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_88;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_375,param2.y * var_377,param2.z * var_376);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_375,param3.y * var_377,param3.z * var_376);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_375,param4.y * var_377,param4.z * var_376);
