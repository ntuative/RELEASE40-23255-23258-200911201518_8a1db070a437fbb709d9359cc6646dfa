package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_422:IRoomObjectFactory = null;
      
      private var var_1367:int;
      
      private var var_2219:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_423 = [];
         var_424 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_427,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_421,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_652,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(_state == const_1117)
         {
            if(var_714 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_422.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_422 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_424.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_422 != null)
         {
            return var_422.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_422.createRoomObjectLogic(_loc18_);
