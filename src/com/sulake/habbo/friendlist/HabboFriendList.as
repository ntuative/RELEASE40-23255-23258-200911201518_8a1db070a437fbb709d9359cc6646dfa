package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1609:IAvatarRenderManager;
      
      private var var_1352:AvatarSearchResults;
      
      private var var_132:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_743:FriendRequests;
      
      private var var_1758:int;
      
      var var_308:FriendCategories;
      
      private var var_195:IHabboToolbar;
      
      private var var_1757:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_382:FriendListTabs;
      
      private var var_1759:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1353:OpenedToWebPopup;
      ...
      {
         var_1757 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_308 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1352 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         try
         {
            HabboWebTools.openWebPage(url,webWindowName);
         }
         catch(e:Error)
         {
         ...
         if(var_1353 == null)
         {
            var_1353 = new OpenedToWebPopup(this);
         }
         var_1353.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_743.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_743.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_382.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_743.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_132 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_308.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_743 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_308.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_308.addCategory(new FriendCategory(FriendCategory.const_820,getText("friendlist.friends")));
         var_308.addCategory(new FriendCategory(FriendCategory.const_391,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_308.addFriend(new Friend(_loc4_));
         }
         var_382 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_308.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1609.createAvatarImage(param1,AvatarScaleType.const_90);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1609 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_743.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_382.findTab(FriendListTab.const_93);
      ...
      {
         var_1759 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_308.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_177.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_382.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         return var_177.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1352.searchReceived(_loc2_.friends,_loc2_.others);
