package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1346:String = "messageinput";
      ...
      private var var_1061:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1061 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_767 = IWindowContainer(var_27.content.findChildByName("main_content"));
         var_259 = IWindowContainer(var_27.content.findChildByName("footer"));
         var_1061.prepare(var_767);
         var_27.procedure = onWindow;
         var_27.content.setParamFlag(HabboWindowParam.const_903,false);
         var_27.content.setParamFlag(HabboWindowParam.const_1170,true);
         var_27.header.setParamFlag(HabboWindowParam.const_569,false);
         var_27.header.setParamFlag(HabboWindowParam.const_920,true);
         var_27.content.setParamFlag(HabboWindowParam.const_569,false);
         var_27.content.setParamFlag(HabboWindowParam.const_920,true);
         var_27.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1062 = ITextWindow(var_27.findChildByName("info_text"));
         var_1062.text = "";
      ...
      public function openFriendList() : void
      {
         ...
         {
            prepare();
            _friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.FRIENDLIST,var_27));
         }
         else
         {
            var_27.visible = true;
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_259.y = Util.getLowestPoint(var_27.content);
         ...
         var_27.scaler.setParamFlag(HabboWindowParam.const_769,this._friendList.tabs.findSelectedTab() != null);
         var_27.scaler.setParamFlag(HabboWindowParam.const_569,false);
         var_27.scaler.setParamFlag(HabboWindowParam.const_903,false);
         var_27.scaler.x = 0 - var_27.scaler.width;
         var_27.scaler.y = 0 - var_27.scaler.height;
         var_1311 = var_27.height;
         var_1312 = var_27.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1311 == -1 ? 0 : int(0 - var_1311);
         var _loc4_:int = var_1312 == -1 ? 0 : int(0 - var_1312);
