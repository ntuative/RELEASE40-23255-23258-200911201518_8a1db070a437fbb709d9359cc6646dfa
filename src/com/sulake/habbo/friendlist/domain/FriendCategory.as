package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_820:int = 0;
      
      public static const const_391:int = -1;
      
      public static const const_307:int = 100;
      ...
      {
         return Math.ceil(this.var_212.length / const_307);
      }
      ...
      {
         if(this.var_732 >= this.getPageCount())
         {
            this.var_732 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_732 + 1) * const_307,this.var_212.length);
      }
