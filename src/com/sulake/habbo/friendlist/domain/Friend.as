package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1402:int = "F".charCodeAt(0);
      
      public static const const_1384:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_678 = param1.online;
         var_1129 = param1.followingAllowed && param1.online;
         var_553 = param1.figure;
         var_1130 = param1.motto;
         var_1128 = param1.lastAccess;
         var_1111 = param1.categoryId;
         var_1131 = param1.realName;
