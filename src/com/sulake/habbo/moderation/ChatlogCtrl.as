package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1436:IMessageComposer;
      ...
      {
         var_754 = IWindowContainer(var_54.getXmlWindow("chatlog_roomheader"));
         var_755 = IWindowContainer(var_54.getXmlWindow("chatlog_chatline"));
         var_445 = new Timer(300,1);
         var_445.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_58 = IFrameWindow(var_54.getXmlWindow("chatlog_frame"));
         ...
         var_54.connection.send(var_1436);
         var_54.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_54.messageHandler.removeChatlogListener(this);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_754.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_58,var_54,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_47 || param2 != var_58)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_755.clone());
         _loc4_.color = var_1122[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_58,var_54,_loc6_,param2.chatterId);
         }
