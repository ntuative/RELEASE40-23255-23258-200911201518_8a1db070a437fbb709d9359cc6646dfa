package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1316:IIssueBrowserView;
      
      private const const_1546:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1547:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1315:IIssueBrowserView;
      
      private const const_1565:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1545:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_210:ITabContextWindow;
      
      private var var_1314:PickedIssuesView;
      
      private var var_310:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_210 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_210.numTabItems)
            {
               _loc5_ = var_210.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_210.selector.getSelectableByName("open_issues");
         var_210.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_310.view.width = var_210.container.width;
         var_310.view.height = var_210.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1545:
               if(var_1315 == null)
               {
                  var_1315 = new MyIssuesView(issueManager,this,var_210.container);
               }
               return var_1315;
            case const_1546:
               if(var_1316 == null)
               {
                  var_1316 = new OpenIssuesView(issueManager,this,var_210.container);
               }
               return var_1316;
            case const_1547:
               if(var_1314 == null)
               {
                  var_1314 = new PickedIssuesView(issueManager,this,var_210.container);
               }
               return var_1314;
            default:
               return null;
