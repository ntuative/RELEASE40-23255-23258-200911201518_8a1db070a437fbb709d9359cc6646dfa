package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1517:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1515:WindowTracker;
      ...
      private var var_1516:ModerationMessageHandler;
      
      private var var_1293:StartPanelCtrl;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1293 = new StartPanelCtrl(this);
         var_1515 = new WindowTracker();
      }
      
      public function userSelected(param1:int, param2:String) : void
      {
         Logger.log("USER SELECTED: " + param1 + ", " + param2);
         this.var_1293.userSelected(param1,param2);
      }
      ...
      public function openHkPage(param1:String, param2:String) : void
      {
         ...
         HabboWebTools.openWebPage(_loc4_,"housekeeping");
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1516 = new ModerationMessageHandler(this);
         }
      }
