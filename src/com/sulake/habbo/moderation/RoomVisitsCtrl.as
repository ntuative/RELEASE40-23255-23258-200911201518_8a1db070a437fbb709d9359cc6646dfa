package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         onResizeTimer(null);
         var_58.visible = true;
         var_54.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1520.clone());
         ...
         new OpenRoomTool(var_58,var_54,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(var_54,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_1520 = IWindowContainer(var_54.getXmlWindow("roomvisits_row"));
         var_445 = new Timer(300,1);
         var_445.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_54.messageHandler.addRoomVisitsListener(this);
         var_54.connection.send(new GetRoomVisitsMessageComposer(_userId));
         var_58 = IFrameWindow(var_54.getXmlWindow("roomvisits_frame"));
      ...
      {
         return WindowTracker.const_1126;
      }
   }
}
