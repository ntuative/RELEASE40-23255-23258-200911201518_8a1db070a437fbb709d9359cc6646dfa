package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1010:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_54,WindowTracker.const_620,_data.flatId),var_58,false,false,true);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new UserInfoFrameCtrl(var_54,_data.ownerId),var_58,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var_54.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1261,_loc2_,var_380.text,"",""));
         if(false)
         {
            var_54.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1011.isSelected,var_1010.isSelected,var_679.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_679 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_1011 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_1010 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
         ...
         var_54.disableButton(var_54.initMsg.bobbaFilterPermission,var_58,"bobba_filter_but");
      ...
      {
         var_58 = IFrameWindow(var_54.getXmlWindow("roomtool_frame"));
         var_54.messageHandler.addRoomInfoListener(this);
         var_54.connection.send(new GetModeratorRoomInfoMessageComposer(var_366));
