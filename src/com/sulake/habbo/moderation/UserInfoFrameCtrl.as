package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_842:UserInfoCtrl;
      ...
      {
         var_58 = IFrameWindow(var_54.getXmlWindow("user_info_frame"));
         var_58.caption = "User Info";
         var _loc1_:IWindow = var_58.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_842 = new UserInfoCtrl(var_58,var_54,true);
         var_842.load(var_58.content,_userId);
         var_58.visible = true;
      }
