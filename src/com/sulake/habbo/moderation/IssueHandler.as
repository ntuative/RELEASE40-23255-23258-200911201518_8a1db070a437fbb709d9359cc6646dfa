package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1012:UserInfoCtrl;
      
      private var var_159:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.releaseBundle(var_159.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_404 = new UserInfoCtrl(_window,var_63);
         var_1012 = new UserInfoCtrl(_window,var_63);
         var_404.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_159.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1012.load(_loc3_,var_159.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_159.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_159.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_159.getHighestPriorityIssue().issueId;
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_786,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_63 != null && false && var_159 != null)
         {
            var_63.issueManager.removeHandler(var_159.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_159.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_159.id,3);
         checkAutoHandling();
         dispose();
      }
