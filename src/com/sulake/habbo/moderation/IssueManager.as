package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_859:String = "issue_bundle_open";
      
      public static const const_491:String = "issue_bundle_my";
      
      public static const const_950:String = "issue_bundle_picked";
      ...
      private var var_511:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_125 = new Map();
         var_727 = new Map();
         var_511 = new IssueBrowser(this,var_63.windowManager,var_63.assets);
         var_598 = [];
         var_726 = [];
         var_886 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_886.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:IssueBundle = var_125.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_598 = var_598.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_727.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_125.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_125.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_727.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1243)
         {
            var_155.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_125)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_727.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_727.add(param1.issueId,_loc2_);
            var_125.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_598.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_137)
         {
            _loc5_ = getBundles(const_491);
            _loc6_ = false;
            ...
            _loc8_ = var_726.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_726 = var_726.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_125.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_886.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_125.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_511 == null || !var_511.isOpen())
         {
            var_63.soundManager.playSound(HabboSoundTypesEnum.const_818);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_727.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_125.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_125.getValues();
