package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_739:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_739) + " mins ago";
         }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_756.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_54.getXmlWindow("user_info"));
            var_756.addChild(_loc1_);
            var_54.disableButton(var_54.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_54.disableButton(var_54.initMsg.alertPermission,_loc1_,"message_but");
            var_54.disableButton(var_54.initMsg.alertPermission || var_54.initMsg.kickPermission || var_54.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new ModActionCtrl(var_54,_data.userId,_data.userName),_callerFrame,var_928,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_54,WindowTracker.const_914,_data.userId),_callerFrame,var_928,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new RoomVisitsCtrl(var_54,_data.userId),_callerFrame,var_928,false,true);
      }
      ...
      {
         var_54.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_54.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_54 = null;
         _data = null;
         var_756 = null;
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_54.messageHandler.addUserInfoListener(this);
         var_54.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_54.windowTracker.show(new SendMsgsCtrl(var_54,_data.userId,_data.userName),_callerFrame,var_928,false,true);
      }
