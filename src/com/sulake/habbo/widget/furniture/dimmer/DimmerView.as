package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1015:Number = 100;
      
      private static const const_1016:Number = 100;
       
      
      private var var_1119:XML;
      
      private var var_399:int;
      
      private var var_444:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1799:int;
      
      private var var_318:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_210.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_210.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1015,const_1016,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_444 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_318 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_210 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_210.numTabItems)
         {
            _loc6_ = var_210.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_33,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_444 != null)
         {
            var_444.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_210.selector.getSelected();
         return var_210.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_318 != null)
         {
            var_318.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_925 = _loc2_.light;
         if(var_318 != null)
         {
            var_318.setValue(var_925);
         }
         var_399 = colors.indexOf(_loc2_.color);
         if(var_444 != null)
         {
            var_444.setSelectedColorIndex(var_399);
         }
