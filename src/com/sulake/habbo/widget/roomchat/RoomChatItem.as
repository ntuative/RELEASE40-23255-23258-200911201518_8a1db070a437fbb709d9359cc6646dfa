package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_476:int = 6;
      
      private static const const_329:int = 10;
      
      private static const const_993:Number = 18;
      
      private static const const_1344:Number = 10;
      
      private static const const_1343:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_875,var_876,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_875,var_876,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1057 = param1.chatType;
         var_875 = param1.userId;
         var_713 = param1.userName;
         var_876 = param1.userCategory;
         _message = param1.text;
         var_1058 = param1.userX;
         var_186 = param1.userImage;
         var_877 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            param1.setParamFlag(HabboWindowParam.const_33,true);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1057)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_248:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_252:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_186 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_186.height);
         }
         ...
         if(var_186 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_186.width;
               _loc28_.height = var_186.height;
               _loc28_.bitmap = new BitmapData(var_186.width,var_186.height,true,0);
               _loc28_.bitmap.copyPixels(var_186,var_186.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_360 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_186.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_877 != 0)
            {
               _loc31_ = uint(var_877 >> 16 & 255);
               _loc32_ = uint(var_877 >> 8 & 255);
               _loc33_ = uint(var_877 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1057 == RoomWidgetChatUpdateEvent.const_248)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_713);
            }
            else if(var_1057 == RoomWidgetChatUpdateEvent.const_252)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_713);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_360;
            _loc20_.width = _loc20_.textWidth + const_476;
            _width += _loc20_.textWidth + const_476;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_329 + _loc20_.textWidth + const_476;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_875,var_876,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_875,var_876,_roomId,_roomCategory,param1);
      }
