package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements ICoreUpdateReceiver
   {
      ...
      private static const const_482:int = (const_483 + const_334) * const_88 + const_88;
       
      
      private var var_766:Number = 1;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_223 = new Array();
         var_628 = new Point();
         var_153 = const_482 + const_270;
         super(param1,param2,param3);
         var_1859 = param5;
         var_43 = param1.createWindow("chat_container","",HabboWindowType.const_55,HabboWindowStyle.const_38,HabboWindowParam.const_33,new Rectangle(0,0,200,var_153 + RoomChatHistoryPulldown.const_70),null,0) as IWindowContainer;
         var_43.background = true;
         var_43.color = 33554431;
         var_43.tags.push("room_widget_chat");
         var_321 = param1.createWindow("chat_contentlist","",HabboWindowType.const_891,HabboWindowStyle.const_39,0 | 0 | 0,new Rectangle(0,0,200,var_153),null,0) as IItemListWindow;
         var_43.addChild(var_321);
         var_131 = param1.createWindow("chat_active_content","",HabboWindowType.const_55,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,200,var_153),null,0) as IWindowContainer;
         var_321.addListItem(var_131);
         var_37 = new RoomChatHistoryViewer(this,param1,var_43,param2);
         var_1860 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_586,onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_253,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_578,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         var_321.width = 0 - 0;
         var_321.height = var_153;
         var_131.width = 0 - 0;
         if(historyViewerActive())
         {
            var_131.height = getTotalContentHeight() + const_270;
         }
         else
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_953)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_70.length > const_1037 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_630 = getTimer() + const_745;
         }
         else
         {
            if(false && false)
            {
               var_532 = getItemSpacing(_itemList["-1"],var_70[0]);
            }
            else
            {
               var_532 = const_88;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_628.x) * var_766;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1140 && !historyViewerActive())
         {
            resetArea();
            var_1140 = false;
         }
      ...
      {
         return "chat_" + var_1859.toString() + "_item_" + (var_1861++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_586,onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_253,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_578,onRoomViewUpdate);
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(_loc2_ == -1)
            {
               param1.y = getAreaBottom() - (_loc3_ + 1) * const_88 - const_270;
            }
            else
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1038 * const_1035;
            if(_loc2_ + var_629 > var_532)
            {
               _loc2_ = var_532 - var_629;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1380 == 0)
            {
               var_1380 = param1.scale;
            }
            else
            {
               var_766 = param1.scale / var_1380;
            }
         }
         if(param1.positionDelta != null)
         {
            var_628.x += param1.positionDelta.x / var_766;
            var_628.y += param1.positionDelta.y / var_766;
         }
         if(param1.rect != null)
         {
            if(var_37 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1860)
         {
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_483 + const_334 + 2)
               {
                  _loc1_.aboveLevels = const_483 + const_334 + 2;
               }
               var_448 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_153 = param1 - 0;
         var_43.height = var_153 + RoomChatHistoryPulldown.const_70;
         if(var_37 != null)
         {
            var_37.containerResized(var_43.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc6_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_304,param1,param2);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_334 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1036)
               {
