package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1559:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1558:String = "level";
      
      private var var_111:IItemListWindow;
      
      private const const_1561:String = "energy";
      ...
      private const const_1557:uint = 3355443;
      
      private var var_230:IBorderWindow;
      
      private const const_1562:int = 158;
      
      private const const_1560:int = 16;
      ...
      private const const_1563:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_230 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_230 != null)
         {
            var_111 = var_230.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_230.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_230.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_111 == null || var_230 == null || var_64 == null)
         {
            return;
         }
         ...
         var_230.height = NaN;
         _window.width = Math.max(var_230.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1138.getValue(var_795) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1558,param1.level,param1.levelMax);
         updateStateElement(const_1563,param1.experience,param1.experienceMax);
         updateStateElement(const_1561,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_795 = param1.id;
         var_1138.remove(param1.id);
         var_1138.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_446,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1562,const_1560,false);
