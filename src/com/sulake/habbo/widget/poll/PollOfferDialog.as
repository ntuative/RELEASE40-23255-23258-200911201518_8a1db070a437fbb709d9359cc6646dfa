package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_265:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_511:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1207:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     _state = const_1207;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_538,_id));
                     break;
                  case "poll_offer_button_cancel":
                     _state = const_511;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_394,_id));
