package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function method_5(param1:IWindowContainer, param2:Array) : void
      {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_590[var_873] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_276)
         {
            ...
            var_276 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_276.center();
            var_276.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_873;
         if(var_873 < var_590.length)
         {
            _loc1_ = var_590[var_873] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_590.length);
                  _loc2_.text = _loc6_;
               }
               ...
               switch(_loc3_)
               {
                  case 1:
                     ...
                     break;
                  case 2:
                     method_5(_loc4_,_loc1_["selections"]);
                     break;
                  case 3:
