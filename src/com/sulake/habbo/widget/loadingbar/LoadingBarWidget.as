package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_394:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_394 = new Sprite();
            var_394.addChild(new Bitmap(_image));
            var_394.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_394.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_394);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1437 != "")
         {
            HabboWebTools.openWebPage(var_1437);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_394 != null)
         {
            var_394.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_394 = null;
         }
         if(_image != null)
         {
