package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1360:int = 5;
      
      private static const const_476:int = 16;
      
      private static const const_1060:int = 20;
      
      private static const const_329:int = 10;
      
      private static const const_1061:int = 40;
      ...
      private var var_387:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1966 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1965 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_656 = new Timer(1000,1);
         var_656.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_790 = new Timer(5000,1);
         var_790.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_232,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1967 = _loc2_.width + const_476 + _loc6_.width + const_1060;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1061,_loc8_.width) + const_476);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_387);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_387);
         }
