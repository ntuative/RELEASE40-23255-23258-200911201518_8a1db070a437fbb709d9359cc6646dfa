package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_469:String = "TUI_CLOTHES_VIEW";
      
      public static const const_381:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_54 = param1;
         var_54.events.addEventListener(HabboHelpTutorialEvent.const_526,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_54.hideUI();
         var_54.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_98));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_935 = true;
         if(var_40 != null && (var_40.id == const_261 || var_40.id == const_87))
         {
            showView(const_87);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1394;
         _window.width = _loc2_.width + var_1395;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_526:
               var_936 = true;
               if(var_40 != null && var_40.id == const_381)
               {
                  showView(const_87);
               }
         }
      ...
      {
         var_934 = true;
         if(var_40 != null && (var_40.id == const_469 || var_40.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      {
         return var_934 && var_935 && var_936;
      }
   }
}
