package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new FaqClientFaqsMessageEvent(method_15));
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_41.tellUI(HabboHelpViewEnum.const_188,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_41.tellUI(HabboHelpViewEnum.const_243,_loc6_);
      }
      ...
      private function method_15(param1:IMessageEvent) : void
      {
         var _loc6_:* = null;
         var _loc7_:int = 0;
         ...
         var_41.tellUI(HabboHelpViewEnum.const_125);
      }
      ...
      {
         var_41.showUI(HabboHelpViewEnum.const_294);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_41.showUI(HabboHelpViewEnum.const_467);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_41.showUI(HabboHelpViewEnum.const_515);
         var_41.tellUI(HabboHelpViewEnum.const_515,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_464)
            {
         ...
         var_41.tellUI(HabboHelpViewEnum.const_553);
      }
