package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1358:int = 0;
      
      private static const const_1359:int = 0;
      ...
      private var var_1873:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23255-23258-200911201446");
         var_195 = param5;
         var_117 = new Map();
         var_117.add(HabboHelpViewEnum.const_1092,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_125,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_467,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_243,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_188,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_515,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_294,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_572,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_207,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_117.add(HabboHelpViewEnum.const_553,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1395 = 0 - _loc3_.width;
         var_1394 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_255 == HabboHelpViewEnum.const_125 || false)
         {
            return;
         }
         if(var_381 == null)
      ...
      {
         return var_117.getValue(var_255);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_117.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_117.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1872 = param1;
         var _loc2_:IHelpViewController = var_117.getValue(HabboHelpViewEnum.const_125) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_207:
               showUI(HabboHelpViewEnum.const_207);
               break;
            case CallForHelpResultEnum.const_809:
      ...
      {
         var _loc3_:* = null;
         if(var_255 == HabboHelpViewEnum.const_125)
         {
            return;
         }
         if(true)
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1394;
         _window.width = _loc1_.width + var_1395;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_117.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_255);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_195 != null)
            {
               var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_41.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_526));
      }
