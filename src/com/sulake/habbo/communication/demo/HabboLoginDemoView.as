package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_338:HabboCommunicationDemo;
      ...
      {
         var_338.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_338.shockwaveClientUrl = var_119.shockwaveClientUrl;
         var_338.ssoTicket = var_119.ticket;
         var_119.removeEventListener(SSOTicket.const_326,onParsedTicketSuccess);
         var_119.removeEventListener(SSOTicket.const_226,onParsedTicketFailure);
         var_119 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1350,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_338 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_338.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_325,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_338.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1350,"/");
         if(_loc5_ != null)
         {
      ...
      private function method_8() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_338.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_338.habboCommunication.habboWebLogin(name,password);
         var_119 = new SSOTicket(var_338.assets,_loc2_,_loc1_);
         var_119.addEventListener(SSOTicket.const_326,onParsedTicketSuccess);
         var_119.addEventListener(SSOTicket.const_226,onParsedTicketFailure);
      }
