package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1736:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1350:ILogger;
      
      private var var_1096:String;
      
      private var var_1734:String;
      
      private const const_1350:String = "fuselogin";
      ...
      private var var_75:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_909)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_16);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_315:
            ...
            case DisconnectReasonEvent.const_936:
               ...
               break;
            case DisconnectReasonEvent.const_829:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1735)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_611 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_611);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1096,var_1734));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1350,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1736);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1350,"/");
      ...
      {
         var_611 = _habboConfiguration.getKey("sso.ticket",null);
         var_1096 = _habboConfiguration.getKey("flash.client.url","");
         var_1734 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_611 != null)
         {
            var_75.mode = HabboConnectionType.const_471;
            var_75.initConnection(HabboConnectionType.const_229);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1350 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_75 = param2 as IHabboCommunicationManager;
            _loc3_ = var_75.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_75.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_75.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_75.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_75.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_75.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_75.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_75.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_75.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_75.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_75.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_75.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_75.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_75.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_594);
            _loc3_ = new InitCryptoMessageComposer(var_75.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1736 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_75.mode)
         {
            case HabboConnectionType.const_471:
               _loc6_ = "";
               ...
               var_910 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_910,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1236:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1249:
               var_908 = generateRandomHexString(30);
               var_441 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_441.init(var_908);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_910);
         ...
         var _loc9_:IConnection = var_75.getHabboMainConnection(null);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_15,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_96,onRoomSessionEnded);
      }
