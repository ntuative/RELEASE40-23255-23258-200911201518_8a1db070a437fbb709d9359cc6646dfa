package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_194:Purse;
      
      private var var_1891:Boolean = true;
      ...
      private var var_638:PurchaseConfirmationDialog;
      
      private var var_734:IHabboSoundManager;
      
      private var var_323:ICatalogViewer;
      
      private var var_1892:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_1035:IAvatarRenderManager;
      
      private var var_383:ICatalogNavigator;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_194.credits = _loc3_.balance;
         updatePurse();
         if(!var_1891 && var_734 != null)
         {
            var_734.playSound(HabboSoundTypesEnum.const_904);
         }
         var_1891 = false;
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_89 == null)
         {
            return;
         }
         var_89.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_177.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_177.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               var_1153 = param1.session.isPrivateRoom;
               if(var_89 != null)
               {
                  var_89.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_96:
               ...
               if(var_89 != null)
               {
                  var_89.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_89 != null && getCurrentLayoutCode() == "recycler")
            {
               var_89.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_198,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_383 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_89 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_194.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_194.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_638 == null)
            {
               var_638 = new PurchaseConfirmationDialog(_localization);
            }
            var_638.showOffer(this,param1,param2,param3);
         }
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_89.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            toggleCatalog(true);
            var_383.openPage(param1);
         }
      }
      
      private function setHabboToolbarIcon() : void
      {
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_383.buildCatalogIndex(_loc2_);
         if(var_952 != "")
         {
            var_383.openPage(var_952);
            var_952 = "";
         }
         else
         {
            var_383.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_206)
         {
            _loc3_ = var_177.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.openWebPage(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_323 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_323.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_194.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1892 && var_734 != null)
         {
            var_734.playSound(HabboSoundTypesEnum.const_850);
         }
         var_1892 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_194.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_194.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_194.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_194.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_323.getCurrentLayoutCode();
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         var_89.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_323.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_323.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_323 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
