package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_515)
               {
                  ...
                  HabboCatalog(var_81).purchaseProduct(var_601,var_168,var_903,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_81).purchaseProduct(var_601,var_168,var_903);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_window == null)
         {
            _window = var_81.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_325,HabboWindowStyle.const_39,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_714,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_551,onActivateGift);
         }
         _window.center();
