package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_299:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_516,activateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            var_180.stop();
            var_180.removeEventListener(TimerEvent.TIMER,populateItemGrid);
            var_180 = null;
         }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_722 >= 0 && var_722 < page.offers.length)
            {
               _loc4_ = page.offers[var_722];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1277) as IWindowContainer;
         var_853.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         param1.productContainer.initProductIcon(page.viewer.roomEngine);
         if(param1.pricingModel == Offer.const_472)
         {
            ++var_1317;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1317);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_145)
         {
            var_180 = new Timer(25);
            var_180.addEventListener(TimerEvent.TIMER,populateItemGrid);
            var_180.start();
         }
      }
