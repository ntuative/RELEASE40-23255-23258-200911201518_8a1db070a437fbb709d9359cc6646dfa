package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1046:String = "default";
      
      private var var_1136:Array;
      
      private var var_940:BitmapData = null;
      
      private var var_220:int = 0;
      
      private var var_623:int = 0;
      
      private var var_1045:String = "1.1";
      ...
      private var var_939:BitmapData = null;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_940 != null && var_939 != null)
         {
            setRoomImage(var_940,var_939);
         }
      }
         ...
         switch(param1)
         {
            case const_170:
               ...
               for each(_loc8_ in var_177.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_624 = _loc8_.children().length();
                  }
               }
            ...
            case const_171:
               ...
               for each(_loc9_ in var_177.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_622 = _loc9_.children().length();
                  }
               }
            ...
            case const_172:
               ...
               for each(_loc10_ in var_177.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_623 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1046);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1134[var_288];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1045);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1046,var_1045,64,this,"window_romantic_wide");
