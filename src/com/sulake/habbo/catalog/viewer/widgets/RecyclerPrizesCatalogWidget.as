package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_299:IGridItem;
      
      private var var_1277:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_782:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_651.length)
         {
            createLevelItem(var_651[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_782 = new PrizeViewer();
         var_899 = new Map();
         var_651 = recycler.getPrizeTable();
         if(var_651 == null)
         {
            return;
         }
         ...
         var_1936 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_651[0].prizes.length > 0)
         {
            select(var_651[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1936) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1277) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_782.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
