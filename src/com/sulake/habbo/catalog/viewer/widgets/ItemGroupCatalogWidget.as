package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_523[var_920] as Array;
      ...
      {
         var _loc2_:Offer = var_523[var_920][var_1797];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_441 || _loc1_.pricingModel == Offer.const_349)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_139 || _loc3_.productType == ProductTypeEnum.const_154)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_919.indexOf(_loc5_) == -1)
                        {
                           var_919.push(_loc5_);
                           var_523.push(new Array());
                        }
                        _loc6_ = var_919.indexOf(_loc5_);
                        (var_523[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_523)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_523)
         {
            if(var_1797 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1797] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_920 = var_853.getGridItemIndex(param1.view);
