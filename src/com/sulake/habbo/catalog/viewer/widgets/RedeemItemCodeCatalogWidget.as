package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_972 != null)
         {
            var_972.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_973 != null)
         {
            var_973.removeEventListener(WindowKeyboardEvent.const_133,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_972 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_972 != null)
         {
            var_972.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_973 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_973 != null)
         {
            var_973.addEventListener(WindowKeyboardEvent.const_133,windowKeyEventProcessor);
         }
      }
