package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2212:String = "magic.pixels";
      
      private var var_2210:String = "catalog.page.club";
      
      private var var_2211:String = "magic.credits";
      ...
      {
         var_81.openCatalogPage(var_2210,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_81.loadCatalogPage(param1.pageId);
         var_81.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function method_11(param1:String) : ICatalogNode
      {
      ...
      public function openFrontPage() : void
      {
         ...
         var_81.loadCatalogPage(_loc1_.pageId);
      }
      ...
      {
         var _loc2_:ICatalogNode = method_11(param1);
         if(_loc2_ != null)
         {
            var_81.loadCatalogPage(_loc2_.pageId);
         }
