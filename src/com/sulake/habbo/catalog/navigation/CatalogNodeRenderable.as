package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1046:Number = 4285716709;
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1388) as IItemListWindow;
         if(_list == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1295;
            }
         }
      }
