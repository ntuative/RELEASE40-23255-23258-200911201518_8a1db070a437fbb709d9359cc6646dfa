package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_337:int = 1;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1435)
         {
            case RecyclerStatusMessageEvent.const_1219:
               var_260 = const_337;
               if(_view == null)
               {
                  return;
               ...
               var_81.setupInventoryForRecycler(true);
               verifyRoomSessionStatus();
               updateRecyclerSlots();
               updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_811:
               if(_view == null)
               {
                  return;
               }
               _view.displayDisabledView();
               var_81.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1215:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         var_260 = const_756;
         var_100 = new Array(const_158);
         if(param1 == null)
         {
            return;
         }
         _view = param1;
         var_81.getRecyclerStatus();
      }
      ...
      public function storePrizeTable(param1:Array) : void
      {
         ...
         {
            _loc3_ = new PrizeLevelContainer(param1[_loc2_],var_81);
            var_651.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      {
         return active && var_260 == const_337;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         var itemId:int = var_81.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_913:
               if(_view != null)
               {
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_81.returnInventoryFurniFromRecycler(var_100[param1].id))
         {
            return;
         }
         var_100[param1] = null;
