package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_703 = new Array();
         _state = param1.id;
         var_1107 = param1.nextState;
         var_1049 = param1.loop;
         if(param1.background != null)
         {
            var_702 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_704.push(new XML());
               var_703.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_703[var_58] = param6.clone();
         }
      ...
      {
         if(var_1049 == true || var_589 == 0)
         {
            if(false)
            {
               ++var_58;
               if(var_58 >= var_704.length)
               {
                  var_58 = 0;
                  ++var_589;
               }
      ...
      {
         return var_704.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1049 == false && var_589 == 1 && var_1107 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_702 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_702.width),Math.max(param2.height,var_702.height));
            _loc3_.copyPixels(var_702,var_702.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_58 <= var_703.length)
         {
            _loc2_ = var_703[var_58];
