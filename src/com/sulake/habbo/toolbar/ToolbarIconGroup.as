package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_285.length)
         {
            _loc2_ = var_285[_loc3_];
            if(_loc2_ != null)
            {
      ...
      {
         return var_613.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1102.length)
         {
            _loc2_ = var_613.indexOf(var_1102[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_285[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_830 + _loc3_);
                  _loc3_ += var_1103;
               }
            }
            _loc4_++;
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_285[var_613.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1751.elements("menu");
         var _loc5_:int = 0;
