package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1035:Number = 90;
      
      private static const const_746:int = 50;
      
      private static const const_1038:Number = 25;
      
      private static const const_1051:int = 50;
      
      private static const const_173:Boolean = true;
       
      
      private var var_542:Timer;
      
      private var var_954:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_954 = param2;
         var_542 = new Timer(const_1038);
         var_542.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_185,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_454[var_455.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_954.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_954.getIconLoc(param1.iconId);
      ...
      {
         return var_455[var_454.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_541[_loc3_] = new Array();
            }
            if(var_541[_loc3_].indexOf(param1) < 0)
            {
               var_541[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_746 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_746 || param1.desktop.height - param1.y < const_1051;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_455.length)
         {
            if(var_455[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_541[_loc3_].length)
                  {
                     repositionWindow(var_541[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
