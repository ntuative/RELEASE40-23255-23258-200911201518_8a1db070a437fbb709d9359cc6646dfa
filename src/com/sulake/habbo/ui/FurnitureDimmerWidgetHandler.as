package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_415:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_534);
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REMOVE_DIMMER:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_908));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_498,RoomWidgetDimmerSavePresetMessage.const_612,RoomWidgetDimmerChangeStateMessage.const_698,RoomWidgetDimmerPreviewMessage.const_662];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_498:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerGetPresetsMessage();
               }
               break;
            case RoomWidgetDimmerSavePresetMessage.const_612:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_698:
               if(validateRights())
               {
