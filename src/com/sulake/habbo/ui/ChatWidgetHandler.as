package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_417:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_418.length)
            {
               _loc2_ = var_418.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_418.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_580.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_322:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_90);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_90);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_43).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_418.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_580.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_659,RoomWidgetChatSelectAvatarMessage.const_574];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_659:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_143,_container.roomSession,0,"Version 23255-23258-200911201446");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_318);
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_95:
                           _container.roomSession.method_17(_loc3_.text);
                           break;
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_694 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_694);
            }
            if(var_417 == null)
            {
               var_416.x = 0;
               var_416.y = 0;
               var_416.z = 0;
               var_417 = _loc4_.getScreenPoint(var_416);
               var_694 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_416.x = 0;
            var_416.y = 0;
            var_416.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_416);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_417.x || _loc8_.y != var_417.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_417,_loc5_));
