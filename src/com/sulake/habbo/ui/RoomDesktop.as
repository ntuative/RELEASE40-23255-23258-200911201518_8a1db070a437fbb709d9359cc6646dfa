package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1042:Boolean = true;
      
      private var _widgets:Map;
      
      private var var_1511:IHabboHelp = null;
      ...
      private var var_692:IRoomWidgetFactory = null;
      ...
      private var var_1035:IAvatarRenderManager = null;
      ...
      private var var_1512:uint = 16777215;
      
      private var var_81:IHabboCatalog = null;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_652,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_579 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_435 != null && true)
         {
            var_1042 = !var_435.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_239[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_652,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_692 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1512);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_195 != null)
         {
            var_208.toolbarSize = var_195.size;
            var_208.toolbarOrientation = var_195.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_239[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_692.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_688:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_273,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_1292 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = var_47.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_464)
                  {
                     var_1292.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_219:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_470:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_194,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_117:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_498,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_356:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_579);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_547);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_634);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_510);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_215);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_414:
               ...
               var_163 = _windowManager.createWindow("room_ad_tooltip","${ads.roomad.tooltip}",WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_247,WindowParam.const_80) as IToolTipWindow;
               var_163.setParamFlag(WindowParam.const_45,false);
      ...
      {
         if(var_579 == null || false)
         {
            return;
         }
         var _loc2_:int = var_579.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_579.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_34 != null && var_47 != null && var_1042 && var_9)
         {
