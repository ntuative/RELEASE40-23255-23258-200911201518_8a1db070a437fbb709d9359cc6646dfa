package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, ICoreUpdateReceiver
   {
      ...
      private var var_734:IHabboSoundManager;
      
      private var var_1513:IHabboAvatarEditor = null;
      
      private var var_435:IAdManager;
      
      private var var_692:IRoomWidgetFactory;
      ...
      private var var_1035:IAvatarRenderManager;
      
      private var var_246:Map;
      
      private var var_195:IHabboToolbar;
      
      private var var_1292:IHabboModeration;
      ...
      private var var_1511:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_902 = RoomDesktop.const_347;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_734 = param2 as IHabboSoundManager;
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_275:
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_435 != null && false)
         {
            ...
            var_435.events.addEventListener(AdEvent.const_455,adEventHandler);
            var_435.events.addEventListener(AdEvent.const_402,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_692 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_692 != null)
         {
            var_692.release(new IIDHabboRoomWidget());
            var_692 = null;
         }
         if(var_28 != null)
         {
         ...
         if(var_734 != null)
         {
            var_734.release(new IIDHabboSoundManager());
            var_734 = null;
         }
         if(var_246)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_347)
            {
               var_902 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1292 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_1292);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_671:
               ...
               if(var_902 != RoomDesktop.const_347)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_246,var_902);
               }
               if(var_435 != null)
               {
                  var_435.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_521:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_558:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_636:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_648:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_703,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_671,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_521,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_57,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_558,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_688,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_689,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_356,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1035 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_34)
         {
            var_34.events.addEventListener(RoomSessionEvent.const_275,roomSessionStateEventHandler);
            ...
            var_34.events.addEventListener(RoomSessionChatEvent.const_143,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionUserBadgesEvent.const_112,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionDoorbellEvent.const_99,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionDoorbellEvent.const_115,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionPresentEvent.const_238,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_180,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_204,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_672,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_902,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_867,roomSessionDialogEventHandler);
            ...
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_636,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_648,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_160,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_668,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionErrorMessageEvent.const_607,roomSessionDialogEventHandler);
            var_34.events.addEventListener(RoomSessionQueueEvent.const_359,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionVoteEvent.const_121,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionVoteEvent.const_119,roomSessionEventHandler);
            ...
            var_34.events.addEventListener(RoomSessionPollEvent.const_113,roomSessionEventHandler);
            var_34.events.addEventListener(RoomSessionDimmerPresetsEvent.const_415,roomSessionEventHandler);
         }
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1513 = param2 as IHabboAvatarEditor;
      }
   }
}
