package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1040:Boolean = true;
      
      private var var_691:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1041 = new Timer(100);
         var_1041.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_65 = new Array();
         var_65.push(new RoomLayout(false,104,"a"));
         var_65.push(new RoomLayout(false,94,"b"));
         var_65.push(new RoomLayout(false,36,"c"));
         var_65.push(new RoomLayout(false,84,"d"));
         var_65.push(new RoomLayout(false,80,"e"));
         var_65.push(new RoomLayout(false,80,"f"));
         var_65.push(new RoomLayout(true,80,"g"));
         var_65.push(new RoomLayout(true,74,"h"));
         var_65.push(new RoomLayout(false,416,"i"));
         var_65.push(new RoomLayout(false,320,"j"));
         var_65.push(new RoomLayout(false,448,"k"));
         var_65.push(new RoomLayout(false,352,"l"));
         var_65.push(new RoomLayout(false,384,"m"));
         var_65.push(new RoomLayout(false,372,"n"));
         var_65.push(new RoomLayout(true,416,"o"));
         var_65.push(new RoomLayout(true,352,"p"));
         var_65.push(new RoomLayout(true,304,"q"));
         var_65.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_869 = new TextFieldManager(_navigator,ITextFieldWindow(var_33.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_869.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_65.length)
         {
            _loc6_ = var_65[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_65[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         var_1510 = _navigator.data.hcMember;
      }
      ...
      {
         var_869.goBackToInitialState();
         var_869.input.textBackgroundColor = 4294967295;
         var_691 = var_65[0];
         if(var_1510 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_869.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_691.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1040 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1040 = true;
            _loc3_.y = 1;
