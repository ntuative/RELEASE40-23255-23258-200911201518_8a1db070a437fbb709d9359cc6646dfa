package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_730:TextFieldManager;
      
      private var var_1077:TextFieldManager;
      ...
      private var var_367:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_1078:TextFieldManager;
      ...
      private var var_1329:ICheckBoxWindow;
      ...
      {
         close();
         this.var_367.roomSettingsRefreshNeeded();
      }
      ...
      {
         this.var_730.clearErrors();
         this.var_1078.clearErrors();
         this.var_832.clearErrors();
         this.var_833.clearErrors();
         this.var_892.clearErrors();
         this.var_1077.clearErrors();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_367.roomSettingsRefreshNeeded();
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_242.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_242.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_242.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_242.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_242.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_242.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_242.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_242);
         var_242.findChildByName("ruler").visible = true;
         ...
         if(var_74.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_242,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
         ...
         var_242.height = Util.getLowestPoint(var_242);
      }
      ...
      {
         var_893.visible = param1;
         this.var_367.roomSettingsRefreshNeeded();
      }
      
      private function getFlatControllerContainer(param1:String) : IWindowContainer
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_862,onDoorModePasswordUnselect);
         ...
         refreshCategories();
         this.var_730 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1078 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_832 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_833 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_892 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1077 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1329 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         var_1331 = IWindowContainer(_window.findChildByName("header_container"));
         var_1075 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_894 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_895 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1330 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1076 = IWindowContainer(_window.findChildByName("footer_container"));
         var_242 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_893 = IWindowContainer(_window.findChildByName("password_container"));
         var_1652 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1651 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1327 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1327.procedure = onSwitchView;
         var_893.visible = false;
         if(!_inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1331.visible = _inRoom;
         var_1330.visible = _inRoom;
         var_1651.visible = var_433;
         var_1652.visible = !var_433;
         if(var_433)
         {
            var_895.visible = true;
            var_1076.visible = false;
            refreshFlatControllers();
            var_895.height = Util.getLowestPoint(this.var_895) + 4;
         }
         else
         {
            populateForm();
            ...
            var_1075.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1075.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_894.height = Util.getLowestPoint(this.var_894) + 4;
         }
         var_1327.text = !!var_433 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1331.name,var_1075.name,var_894.name,var_895.name,var_1076.name,var_1330.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         var_730.setText(_loc1_.name);
         var_1078.setText(_loc1_.description);
         var_892.setText("");
         var_1077.setText("");
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_107);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         setCategorySelection(_loc1_.categoryId);
         refreshMaxVisitors(_loc1_);
         setTag(var_832,_loc1_.tags[0]);
         setTag(var_833,_loc1_.tags[1]);
         if(_loc1_.allowPets)
         {
            this.var_1329.select();
         }
         else
         {
            this.var_1329.unselect();
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_730.getText();
         _loc2_.description = var_1078.getText();
         ...
         {
            _loc8_ = var_892.getText();
            _loc9_ = var_1077.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_892.clearErrors();
               this.var_1077.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1329.isSelected;
         ...
         addTag(var_832,_loc2_.tags);
         addTag(var_833,_loc2_.tags);
         this.clearErrors();
         this.var_891 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_366 || var_891 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_891 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1248)
         {
            this.var_730.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1168)
         {
            this.var_730.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1136)
         {
            this.var_1078.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1252)
         {
            setTagError(this.var_832,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_833,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1145)
         {
            setTagError(this.var_832,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_833,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1109)
         {
            this.var_892.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_730.displayError("Update failed: error " + param2);
         }
      }
