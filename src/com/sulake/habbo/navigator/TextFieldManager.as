package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         var_78.addEventListener(WindowKeyboardEvent.const_133,checkEnterPress);
         var_78.addEventListener(WindowEvent.const_232,checkMaxLen);
         this.var_2191 = var_78.textBackground;
         this._orgTextBackgroundColor = var_78.textBackgroundColor;
         this.var_2193 = var_78.textColor;
      }
      ...
      {
         var_78.textBackground = this.var_2191;
         var_78.textBackgroundColor = this._orgTextBackgroundColor;
         var_78.textColor = this.var_2193;
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > var_1463)
         {
            var_78.text = _loc2_.substring(0,var_1463);
         }
      }
   }
}
