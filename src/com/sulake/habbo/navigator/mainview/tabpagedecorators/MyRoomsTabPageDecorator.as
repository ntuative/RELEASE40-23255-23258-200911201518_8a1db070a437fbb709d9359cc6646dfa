package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_458:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_458 == null ? 0 : int(var_458.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_233,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_458 == null)
         {
            var_458 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_458.procedure = onChangeSubNavi;
            method_7();
         }
         _loc3_.visible = true;
      }
