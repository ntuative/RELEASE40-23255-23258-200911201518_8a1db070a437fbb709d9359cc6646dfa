package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1408:IButtonWindow;
      ...
      private var var_90:ThumbnailEditorModel;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_90 = new ThumbnailEditorModel();
      }
      
      private function refreshTab() : void
      {
         setEnabled(_bgTabButton,this.var_90.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1409,this.var_90.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1408,this.var_90.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_90.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(_window.findChildByName("picframe")),var_90.data,false);
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(_active)
         {
            var_90.data = _navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_90.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(_navigator.data.enteredGuestRoom.flatId,var_90.data.bgImgId,var_90.data.frontImgId,_loc3_.length);
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_90.mode = ThumbnailEditorModel.const_51;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1409 = IButtonWindow(find("top_tab"));
         var_1408 = IButtonWindow(find("obj_tab"));
         var_1912 = IWindowContainer(find("tile_grid"));
         var_1911 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1409,onTopTabButton);
         Util.setProcDirectly(var_1408,onObjTabButton);
      }
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = var_90.getImgId();
         var _loc6_:int = 0;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1912;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_378)
            {
         ...
         _loc2_.visible = true;
         refreshTileLoc(_loc2_,var_90.selected.pos);
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_90.mode = ThumbnailEditorModel.const_31;
         this.reload();
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = var_90.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_378)
         {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
