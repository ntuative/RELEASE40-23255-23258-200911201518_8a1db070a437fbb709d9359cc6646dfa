package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_334:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1907:ISessionDataManager;
      
      private var var_1905:RoomCreateViewCtrl;
      ...
      private var var_1164:RoomInfoViewCtrl;
      
      private var var_81:IHabboCatalog;
      
      private var var_382:Tabs;
      
      private var var_457:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_457 = new MainViewCtrl(this);
         var_1164 = new RoomInfoViewCtrl(this);
         var_1905 = new RoomCreateViewCtrl(this);
         var_1614 = new RoomThumbnailRenderer(this);
         var_892 = new GuestRoomPasswordInput(this);
         var_334 = new GuestRoomDoorbell(this);
         var_382 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_457.startSearch(Tabs.const_199,Tabs.const_320,param1);
         var_457.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_177.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1907 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_457.startSearch(Tabs.const_233,Tabs.const_200);
         var_382.getTab(Tabs.const_233).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_457.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
