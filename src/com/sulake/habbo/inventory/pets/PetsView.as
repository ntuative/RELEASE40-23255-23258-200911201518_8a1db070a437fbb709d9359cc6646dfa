package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_299:PetsGridItem;
      ...
      private var var_451:IItemGridWindow;
      
      private var var_90:PetsModel;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_451 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_566 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_566.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_299 != null)
         {
            var_299.setSelected(false);
         }
         var_299 = param1;
         if(var_299 != null)
         {
            var_299.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_53)
         {
            ...
            {
               case "tab_floor":
                  var_90.switchCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  var_90.switchCategory(FurniModel.const_41);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_299.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateGrid() : void
      {
         ...
         var_451.removeGridItems();
         var_566.reset();
         var _loc1_:Map = var_90.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var_90.placePetToRoom(param1,param2);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = var_566.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_451.removeGridItem(_loc2_.window);
         if(var_299 == _loc2_)
         {
            var_299 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_566.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_451.addGridItem(_loc2_.window);
            var_566.add(param1.id,_loc2_);
            if(var_299 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            _loc8_ = var_90.roomSession.arePetsAllowed;
            _loc9_ = var_90.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
