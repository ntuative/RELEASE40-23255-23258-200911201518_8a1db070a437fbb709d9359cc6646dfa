package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1548:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_431,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_55.getValue(InventoryCategory.const_505));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_55.getValue(InventoryCategory.const_68));
      }
      ...
      {
         var_194.clubPeriods = param1;
         var_194.clubDays = param2;
         var_194.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_836));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_55.getValue(InventoryCategory.const_155));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1548);
         }
      }
      ...
      {
         return AchievementsModel(var_55.getValue(InventoryCategory.const_290));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_729.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_729.splice(_loc3_,1);
            }
         }
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_239:
      ...
      {
         return TradingModel(var_55.getValue(InventorySubCategory.const_239));
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1326 = new IncomingMessages(this);
      ...
      {
         return var_194.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_194.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_55.getValue(InventoryCategory.const_224));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_431,roomSessionEventHandler);
         ...
         var_55.add(InventoryCategory.const_155,_loc9_);
