package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_68,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_505);
         _loc2_.refreshViews();
         var_28.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_155);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_28.setInventoryCategoryInit(InventoryCategory.const_290);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_68);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_28.toggleInventorySubPage(InventorySubCategory.const_239);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_28.setInventoryCategoryInit(InventoryCategory.const_224);
      }
