package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2125:BitmapData;
      
      protected var var_852:Boolean;
      
      protected var var_2124:Boolean;
      
      protected var var_1604:int;
      ...
      protected var var_346:BitmapData;
      
      private const const_1348:Number = 0.2;
      
      protected var var_1275:Boolean;
      
      private const const_1349:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_528)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2126 == FurniModel.const_40)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1276);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1348;
               _loc1_.blend = const_1348;
            }
            else
            {
               _window.blend = const_1349;
               _loc1_.blend = const_1349;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1275 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2125;
               _loc5_.visible = true;
            }
            else
            {
