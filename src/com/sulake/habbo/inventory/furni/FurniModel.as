package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_321:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         _assets = param4;
         _roomEngine = param5;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_208,onObjectPlaced);
         var_481 = new Timer(const_1085,1);
         var_481.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_239;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_528)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_208,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_481 != null)
            {
               var_481.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_481.stop();
               var_481 = null;
            }
            if(var_145 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_280)
         {
         ...
         else if(param3 == FurniCategory.const_287)
         {
         ...
         var _loc10_:IWindowContainer = var_680.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_239:
               ...
               break;
            case InventorySubCategory.const_907:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         if(var_838 && param1.type == RoomEngineObjectEvent.const_208)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_280 || _loc3_.category == FurniCategory.const_314 || _loc3_.category == FurniCategory.const_287)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_405 = new Map();
         var_405.add(const_40,new Array());
         var_405.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
