package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_761:uint = 4284532064;
      
      private static const const_760:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_941)
            {
            ...
            var_335.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_405);
            var_335.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_180)
            {
               var_180.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_180.stop();
               var_180 = null;
            }
            if(var_335 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1455 == null)
         {
            var_1455 = createMinimizedWindow();
         }
         if(!var_2016)
         {
            return var_67;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_180 == null)
         {
            var_180 = new Timer(1000,3);
            var_180.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_180.reset();
         var_180.repeatCount = 3;
         var_180.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_761) : uint(const_760);
            }
