package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_152:uint = 0;
      
      public static const const_1118:uint = 9;
      
      public static const const_179:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_447 = false;
         var_626 = false;
         var_51.updateItemList(var_627);
         var_51.updateItemList(var_1139);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_51.alertPopup(TradingView.const_974);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_627)
            {
               var_447 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_626 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_51.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_627)
            {
               var_51.alertPopup(TradingView.const_965);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_447 + " OTHER: " + var_626);
         ...
         {
            case const_152:
               if(param1 == const_162 || param1 == const_179)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_51.setMinimized(param1 != InventoryCategory.const_68);
      ...
      public function close() : void
      {
         if(var_549)
         {
            if(_state != const_152 && _state != const_179)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_152;
            var_28.toggleInventorySubPage(InventorySubCategory.const_907);
            var_549 = false;
         }
         var_51.setMinimized(false);
      }
