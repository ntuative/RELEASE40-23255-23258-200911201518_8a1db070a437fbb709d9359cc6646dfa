package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1542:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_520 = param6;
         var_520.events.addEventListener(BadgeImageReadyEvent.const_167,onBadgeImageReady);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_240[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_240.length)
               {
                  if((var_240[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_240[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_520 != null)
            {
               var_520.events.removeEventListener(BadgeImageReadyEvent.const_167,onBadgeImageReady);
               var_520 = null;
            }
            _disposed = true;
         }
      ...
      {
         if(param1 == InventoryCategory.const_224 && false)
         {
