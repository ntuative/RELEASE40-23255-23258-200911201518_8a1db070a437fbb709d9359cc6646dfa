package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_846:IAvatarRenderManager = null;
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_485.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         switch(param2)
         {
            case RoomObjectVisualizationEnum.const_782:
            ...
            case RoomObjectVisualizationEnum.const_852:
               ...
               break;
            case RoomObjectVisualizationEnum.const_956:
            case RoomObjectVisualizationEnum.const_842:
            case RoomObjectVisualizationEnum.const_255:
            case RoomObjectVisualizationEnum.const_901:
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_846;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_846;
            }
            var_485.add(param1,_loc6_);
            return _loc6_;
         }
         return null;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_485 != null)
         {
            ...
            {
               _loc1_ = var_485.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_846 = param2 as IAvatarRenderManager;
      }
