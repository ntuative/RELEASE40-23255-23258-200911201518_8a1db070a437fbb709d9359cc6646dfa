package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1083:Number = 30;
      ...
      {
         var_675 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1207 = param3;
         var_2061 = param4 * 0 * 2 / 360;
      ...
      {
         var _loc3_:Number = var_1207 * Math.cos(var_830 + var_1472);
         var _loc4_:Number = var_1207 * Math.sin(var_830 + var_1472);
         var _loc5_:Number = _height;
         var_675.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_675.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_675.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_675.add(param1);
         }
