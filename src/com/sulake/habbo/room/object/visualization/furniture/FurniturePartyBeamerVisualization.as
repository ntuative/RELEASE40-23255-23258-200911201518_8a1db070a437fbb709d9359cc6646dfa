package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1001:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_888[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_889[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_888 = new Array();
         var_888.push(Math.random() * _loc2_ * 1.5);
         var_888.push(Math.random() * _loc2_ * 1.5);
         var_890 = new Array();
         var_890.push(1);
         var_890.push(-1);
         var_887 = new Array();
         var_887.push(const_1000);
         var_887.push(const_1001);
         var_889 = new Array();
         var_889.push(getRandomAmplitudeFactor());
         var_889.push(getRandomAmplitudeFactor());
      }
