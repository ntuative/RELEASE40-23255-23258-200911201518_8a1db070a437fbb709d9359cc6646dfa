package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_274:int = 1000;
      ...
      private var var_1100:int = 360;
      
      private var var_1748:int = 0;
      
      private var var_612:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1100 / 2) % 360 / var_1100;
         ...
         {
            _loc6_ = int(var_215.getKey(_loc5_)) * var_1100;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_831);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_877);
                  break;
               case "DARKEN":
