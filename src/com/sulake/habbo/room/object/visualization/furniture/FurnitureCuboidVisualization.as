   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            _loc8_ = var_107[_loc4_] as FurniturePlane;
            if(_loc8_ != null)
            {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + _loc2_.getInstanceId() + "_" + var_1371;
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_289);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_340);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_641);
