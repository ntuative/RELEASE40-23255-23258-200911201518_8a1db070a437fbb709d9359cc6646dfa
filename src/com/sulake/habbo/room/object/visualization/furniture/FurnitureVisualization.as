package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2130:int = -1;
      
      protected var _data:FurnitureVisualizationData = null;
      
      protected var _type:String = "";
      
      protected var var_2122:Number = NaN;
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc7_ != null)
               {
                  ...
                  if(_loc4_ < spriteCount - 1)
                  {
                     ...
                     _loc6_.color = getSpriteColor(_loc4_,var_2130,param1);
                  ...
                  else
                  {
                     ...
                     {
                        _loc9_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_150);
                     }
                     _loc6_.alpha = _loc9_;
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2130 = _loc3_.getNumber(RoomObjectVariableEnum.const_193);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_275 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2122)
         {
