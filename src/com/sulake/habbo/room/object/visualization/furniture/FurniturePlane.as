package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_243.assign(param2);
         var_244 = new Vector3d();
         var_244.assign(param3);
         var_514 = new Vector3d();
         var_514.assign(param2);
         var_513 = new Vector3d();
         var_513.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1679)
         {
            if(!param1)
            {
               var_243.assign(var_514);
               var_244.assign(var_513);
            }
            else
            {
               var_243.assign(var_514);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_76 == null && var_617 != null || var_243 == null || var_244 == null || var_370 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1088)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_901 || _loc4_.y != var_1675 || _loc4_.z != var_1678 || param1.scale != var_1677))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_617);
               _loc7_ = _loc6_.z;
