package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_500:PlaneMaskManager;
      ...
      {
         super();
         var_502 = new WallRasterizer();
         var_501 = new FloorRasterizer();
         _landscapeRasterizer = new LandscapeRasterizer();
         var_500 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc6_ = _loc2_[0];
            var_502.initialize(_loc6_);
         }
         var _loc3_:XMLList = param1.floorData;
         if(_loc3_.length() > 0)
         {
            _loc7_ = _loc3_[0];
            var_501.initialize(_loc7_);
         }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         var_502.initializeAssetCollection(param1);
         var_501.initializeAssetCollection(param1);
         _landscapeRasterizer.initializeAssetCollection(param1);
         var_500.initializeAssetCollection(param1);
         var_775 = true;
      }
