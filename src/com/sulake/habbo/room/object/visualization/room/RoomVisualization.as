package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1090:int = 13421772;
      
      private static const const_1045:int = 16777215;
      
      public static const const_1169:int = 10066329;
      
      private static const const_1043:int = 13421772;
      
      public static const const_1263:int = 16777215;
      
      private static const const_1357:int = 0;
      
      public static const const_1238:int = 16777215;
      ...
      private var var_1046:String = null;
      ...
      private var var_946:uint = 16777215;
      
      private var var_83:RoomPlaneParser = null;
      
      private var var_1045:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1371;
               }
               if(var_83.getPlaneType(_loc4_) == RoomPlaneData.const_135)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_83.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_237)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_218 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_700);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_637);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_616);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_926);
            if(_loc8_ != var_1864)
            {
               updatePlaneMasks(_loc8_);
               var_1864 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_669));
            if(_loc9_ != var_946)
            {
               var_946 = _loc9_;
            }
            var_1865 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_844));
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_172)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_1865)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_946 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_946 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_946 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_778);
         ...
         while(_loc7_ < var_83.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_171,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1263;
               }
               else
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_218,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_237)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_172,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1238;
               }
               else if(_loc14_.y == 0)
               {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_171 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_218 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_172 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_107.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_218 || _loc3_.type == RoomPlane.const_172 && _loc8_ == RoomPlaneBitmapMaskData.const_203)
                  {
