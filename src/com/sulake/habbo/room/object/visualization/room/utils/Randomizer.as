package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2207:int = 69069;
      
      private var var_1142:int = 1;
      
      private var var_2208:int = 5;
      
      private var var_1381:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1381 * param2);
      }
      ...
      {
         var _loc1_:int = var_2207 * var_1142 + var_2208;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
