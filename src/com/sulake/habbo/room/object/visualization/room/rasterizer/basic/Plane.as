package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_597:PlaneVisualization = null;
      ...
      public function createPlaneVisualization(param1:int, param2:int, param3:Number, param4:Number) : PlaneVisualization
      {
         ...
         var_364.add(String(param1),_loc5_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc5_;
      }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_597 = var_364.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_597 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_364 != null)
         {
            ...
            {
               _loc1_ = var_364.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
