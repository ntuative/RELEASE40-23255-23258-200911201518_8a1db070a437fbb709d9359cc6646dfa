package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1188:int = const_311;
      ...
      public static const const_181:int = 4;
      
      public static const const_604:int = 6;
      
      public static const const_228:int = const_92;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1348 == const_92)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_440);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_440,var_38.width,var_440);
         }
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.method_3(var_742,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_440,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
