package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_802:AvatarVisualizationData = null;
      ...
      {
         var_802 = param1 as AvatarVisualizationData;
         createSprites(const_1069);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_696);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_629);
         ...
         var _loc13_:Number = _loc7_ - var_1221;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_276);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_275 != _loc2_.getUpdateID() || var_207 != param1.scale || var_183 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_470 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_470;
            _loc22_ = getTimer();
            if(var_553 != _loc6_)
            {
               for each(_loc48_ in var_401.getKeys())
               {
                  var_401.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_306);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_220) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc5_.setDirectionAngle(AvatarSetType.const_43,_loc24_);
            _loc5_.initActionAppends();
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_220);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_710);
            _loc5_.appendAction(AvatarAction.const_571,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_468);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_346);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_285,AvatarAction.const_1268[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_815);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_912,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_874);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_946);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_960,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_523);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_490);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_940,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_770);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_808,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_462);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_350) > 0;
            if(_loc34_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_458);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_886);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_606,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1552);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_845))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_802.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_803.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_803)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
