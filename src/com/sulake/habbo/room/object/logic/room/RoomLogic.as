package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1485:int = 1500;
      
      private var var_1484:int = 255;
      
      private var var_1483:int = 255;
      
      private var var_1259:uint = 16777215;
      
      private var var_1009:uint = 16777215;
      
      protected var var_83:RoomPlaneParser = null;
      
      private var var_837:int = 0;
      
      private var var_1264:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_489:
                  _loc2_.setString(RoomObjectVariableEnum.const_637,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_496:
                  _loc2_.setString(RoomObjectVariableEnum.const_700,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_653:
                  _loc2_.setString(RoomObjectVariableEnum.const_616,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_460:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_203)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_690:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_926,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_844,int(_loc5_.bgOnly));
            var_1259 = _color;
            var_1484 = var_1264;
            var_1009 = _loc11_;
            var_1483 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_83.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_778,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_83.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_83.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_83.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_83.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_83.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_83.getPlaneNormal(_loc5_);
         var _loc13_:int = var_83.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1104,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1130,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_141 || _loc13_ == RoomPlaneData.const_237)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_837)
         {
            ...
            {
               _loc6_ = var_1259 >> 16 & 255;
               _loc7_ = var_1259 >> 8 & 255;
               _loc8_ = var_1259 & 255;
               _loc9_ = var_1009 >> 16 & 255;
               _loc10_ = var_1009 >> 8 & 255;
               _loc11_ = var_1009 & 255;
               _loc12_ = (_loc1_ - var_837) / var_1485;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1484 + (var_1483 - var_1484) * _loc12_;
               _color = _loc2_;
               var_1264 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_669,_loc2_);
         }
      }
   }
}
