package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_724:String = "selection_arrow";
      
      private static const const_722:String = "tile_cursor";
      
      private static const const_267:String = "RCL_PUBLICROOM_";
      
      private static const const_473:String = "wall_place_holder";
      
      private static const const_982:int = 2;
      
      private static const const_328:String = "place_holder";
      
      private static const const_983:String = const_328;
      
      private static const const_1342:int = 0;
      
      private static const const_723:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_609:String = "RCL_LOADER_READY";
      ...
      private var var_872:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_586 = [];
         var_585 = [];
         var_1539 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1545 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_356 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_495.getValue(param1) as String;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_358 != null)
         {
            _loc2_ = var_358.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_267 + param1))
         {
            return var_164.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_586.indexOf(_loc14_) < 0)
                              {
                                 var_586.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_495.add(_loc10_,_loc11_);
                              if(var_585.indexOf(_loc14_) < 0)
                              {
                                 var_585.push(_loc14_);
                              }
                           }
                           _loc16_ = var_419.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_419.remove(_loc14_);
                              var_419.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_356 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_356.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_309 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_309.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_328,const_473,ROOM_CONTENT,const_722,const_724];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_356.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_496.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_356.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_419.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1539.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_157 && _loc5_ != RoomObjectLogicEnum.const_118)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_586.indexOf(param1) >= 0)
         {
            return const_328;
         }
         if(var_585.indexOf(param1) >= 0)
         {
            return const_473;
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_357 != null)
         {
            _loc2_ = var_357.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1235);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_495.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1545.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_427,_loc5_);
         }
         else
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_230;
         }
         return RoomObjectCategoryEnum.const_197;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1541)
         {
            ...
            if(var_872 != null)
            {
               var_872.dispatchEvent(new Event(const_609));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_267 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_872 = param1;
            var_1540 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1543 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1542 = param2.getKey("public.room.dynamic.download.url","");
            var_1544 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_723;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_309.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_357 != null)
         {
            ...
            var_357.add(param1,param2);
         }
         if(var_358 != null)
         {
            var_358.remove(param2);
            var_358.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_157 && _loc5_ != RoomObjectVisualizationEnum.const_118)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_361.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_309.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_406,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_267 + param1);
         }
         return 32;
      }
