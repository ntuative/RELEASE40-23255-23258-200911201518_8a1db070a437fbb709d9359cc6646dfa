package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1387:PaletteManager;
      
      private var var_690:CoreComponent;
      
      private var var_1350:ILogger;
      
      private var var_1146:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_534.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
         _loc2_ = var_534.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
      ...
      {
         return var_1146 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_534.getValue(AvatarType.const_89) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_29,param1,param2,AvatarType.const_89);
      }
      
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         var _loc5_:String = var_1146.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_534.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1146 = new PetDataManager(_loc2_,_loc4_);
         var_1387 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1146.populateFigureData(_loc5_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.const_89);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_534.add(AvatarType.const_89,_loc6_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.PET);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_534.add(AvatarType.PET,_loc6_);
      ...
      {
         var _loc2_:AvatarStructure = var_534.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1387.getPalette(0);
