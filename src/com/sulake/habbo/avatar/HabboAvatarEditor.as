package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_866:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_866.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_865)
         {
            ...
            var_577["null"] = new FigureData(this);
            var_577["null"] = new FigureData(this);
            _loc1_ = var_577["null"];
            _loc2_ = var_577["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_76);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_78);
            var_308 = new Map();
            var_308.add(AvatarEditorCategory.const_893,new GenericModel(this));
            var_308.add(AvatarEditorCategory.const_43,new HeadModel(this));
            var_308.add(AvatarEditorCategory.const_278,new TorsoModel(this));
            var_308.add(AvatarEditorCategory.const_1302,new LegsModel(this));
            var_308.add(AvatarEditorCategory.const_506,new WardrobeModel(this));
            var_865 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_308.getValue(AvatarEditorCategory.const_506);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_308.getValue(AvatarEditorCategory.const_506);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_866.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1497.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1171)
               {
                  _loc19_ = true;
               }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_308.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_354 == null)
            {
               var_354 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_354.addChild(_view.window);
               var_354.center();
               var_354.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_893);
         if(var_177 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1035 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_566,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_866 = var_1035.getFigureData(AvatarType.const_89);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_864 = param3;
         var _loc4_:FigureData = var_577[param2];
         if(_loc4_ == null)
         {
            return;
         }
