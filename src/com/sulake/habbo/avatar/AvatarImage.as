package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_553:AvatarFigureContainer;
      ...
      private var var_84:AvatarStructure;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_553 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_553.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_980;
         }
         var_128 = new AvatarImageCache(var_84,this,_assets,var_199);
      ...
      private function solvePetAvatarTypeAndRace(param1:int) : void
      {
         ...
         var_980 = 0;
         var_1217 = 0;
         var _loc2_:ISetType = var_84.figureData.getSetType("pbd");
         if(_loc2_ != null)
         {
      ...
      {
         param2 += var_1218;
         if(param2 < AvatarDirectionAngle.const_1310)
         {
            param2 = AvatarDirectionAngle.const_660 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_660)
         {
            param2 -= NaN;
         }
         if(var_843 == AvatarType.PET && param1 == AvatarSetType.const_43)
         {
         ...
         if(var_84.isMainAvatarSet(param1))
         {
            var_101 = param2;
         }
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_84.sortActions(var_200);
         if(_loc1_ == null)
         {
            var_554 = new Array(0,0,0);
         }
         else
         {
            var_554 = var_84.getCanvasOffsets(_loc1_,var_199,var_101);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            {
               _isAnimating = true;
               _loc3_ = var_84.getAnimation(_loc2_.definition.state + "." + _loc2_.actionParameter);
               if(_loc3_ != null)
               {
                  var_175 = var_175.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1218 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_561)
            {
               _isAnimating = true;
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_462)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_84.getPartColor(var_553,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_84.getCanvas(var_199,var_179.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_84.getBodyParts(param1,var_179.definition,var_101);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_469);
            if(_loc10_ != null)
            {
               ...
               if(var_843 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_84.getParts(_loc9_,var_553,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_199 == AvatarScaleType.const_90)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_469);
                     _loc21_ = var_101;
                     _loc22_ = 1;
                     switch(var_101)
                     {
                     ...
                     _loc23_ = var_84.getPartActionOffset(getSubType(),var_199,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_84.getCanvas(var_199,var_179.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_84.getBodyParts(param1,var_179.definition,var_101);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_469);
            if(_loc8_ != null)
            {
               ...
               if(var_843 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_84.getParts(_loc7_,var_553,_loc12_,"pet",_loc11_.getDirection());
                  _loc15_ = 32;
                  if(var_199 == AvatarScaleType.const_90)
                  {
                     _loc15_ = 6;
                  ...
                  {
                     _loc16_ = _loc14_[0];
                     _loc17_ = _loc16_.getFrameIndex(var_469);
                     _loc18_ = var_101;
                     _loc19_ = 1;
                     switch(var_101)
                     {
                     ...
                     _loc20_ = var_84.getPartActionOffset(getSubType(),var_199,_loc7_,_loc13_,_loc17_,_loc18_);
                     if(_loc20_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_468 = null;
         var_1218 = 0;
         var_84.removeDynamicItems();
         var_179 = new ActiveActionData(AvatarAction.const_799);
         var_179.definition = var_84.getActionDefinition(const_1062);
      ...
      {
         return var_84.getBodyPartData(param1.animation.id,var_469,param1.id);
      }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            case AvatarAction.const_571:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1320:
                     if(var_843 == AvatarType.const_89)
                     {
                        if(var_101 == 0)
                        {
            ...
            case AvatarAction.const_808:
               _loc4_ = var_84.getActionDefinitionWithState(param1);
               if(_loc4_ != null)
               {
