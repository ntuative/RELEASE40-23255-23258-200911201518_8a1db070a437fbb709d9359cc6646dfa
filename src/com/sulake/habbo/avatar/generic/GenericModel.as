package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:CategoryData = var_308[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function init() : void
      {
         ...
         var_308["null"] = _controller.generateDataContent(this,FigureData.const_54);
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc4_:CategoryData = var_308[param1];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         for each(_loc5_ in _loc4_.data)
         {
            ...
            _loc5_.iconImage = _loc7_.getCroppedImage(AvatarSetType.const_43).clone();
            _loc7_.dispose();
         }
      }
