package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      private var var_90:GenericModel;
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_54,param2,param3);
         attachImages();
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_90.categorySwitch(FigureData.const_76);
                  param1.stopPropagation();
                  break;
               case "tab_girl":
                  var_90.categorySwitch(FigureData.const_78);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_643[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(var_90.controller.gender)
         {
         ...
         var _loc4_:AvatarEditorGridView = var_643[var_1334];
         if(_loc4_ == null)
         {
            return;
         }
