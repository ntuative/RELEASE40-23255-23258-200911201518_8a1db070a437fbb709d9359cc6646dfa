package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1838 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_930 = new Dictionary();
         var_1369 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_930[String(_loc3_.@id)] = _loc5_;
         }
         for each(_loc4_ in param1.bodypart)
         {
            var_1369.push(String(_loc4_.@id));
         }
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1369.concat();
         for each(_loc2_ in var_930)
         {
      ...
      public function method_4(param1:String) : AvatarSet
      {
         var _loc2_:* = null;
         if(param1 == _id)
         {
         ...
         for each(_loc2_ in var_930)
         {
            if(_loc2_.method_4(param1) != null)
            {
               return _loc2_;
            }
         }
