package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1056:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1056 = _loc4_.content as BitmapData;
         if(_window != null)
         {
      ...
      public function udpate(param1:BitmapData) : void
      {
         ...
         var_471.bitmap.copyPixels(var_1056,var_1056.rect,new Point(0,0 - 0 - 8));
         var_471.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
