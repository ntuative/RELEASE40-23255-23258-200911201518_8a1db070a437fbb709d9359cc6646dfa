package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_123,param2,param3);
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_124,param2,param3);
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_142,param2,param3);
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_138,param2,param3);
         var_643["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         attachImages();
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_643[var_1334];
         if(_loc2_ == null)
         {
            return;
         }
