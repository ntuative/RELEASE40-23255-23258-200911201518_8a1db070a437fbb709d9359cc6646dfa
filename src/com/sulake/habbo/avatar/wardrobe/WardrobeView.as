package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_625:IItemListWindow;
      
      private var var_529:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_764:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_625 = _window.findChildByName("mylooks") as IItemListWindow;
         var_529 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_764 = _window.findChildByName("selector") as IItemListWindow;
         var_1375 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_90.controller.catalog.openCatalogPage(CatalogPageName.const_279,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_90.selectMyLook(var_625.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_764.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_530 = [];
         while(true)
         {
            ...
            var_764.addListItem(_loc1_.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_764.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_763 * 8 + var_529.getListItemIndex(param2.parent);
