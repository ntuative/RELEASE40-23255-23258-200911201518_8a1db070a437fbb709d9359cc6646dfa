package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1540:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1449:BitmapData;
      
      private const const_1541:int = 13421772;
      
      private var var_807:Rectangle;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         var_987 = param5;
         var _loc8_:IAvatarRenderManager = var_90.controller.avatarRenderManager;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_556 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1449,var_1449.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1541;
         }
         else
         {
            _window.color = const_1540;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_807.width,var_807.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_932 + "_" + FigureData.const_263;
            _loc4_ = var_90.controller.avatarRenderManager.getAssetByName(_loc3_) as BitmapDataAsset;
            if(_loc4_ != null)
            {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_932 + "_" + FigureData.const_263;
            _loc3_ = var_90.controller.avatarRenderManager.getAssetByName(_loc2_) as BitmapDataAsset;
            if(_loc3_ != null)
            {
