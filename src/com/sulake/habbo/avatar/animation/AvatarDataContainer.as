package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1977:uint;
      
      private var var_967:uint;
      
      private var var_971:Map;
      
      private var var_1427:Number = 1;
      ...
      private var var_1976:uint;
      
      private var var_1431:uint;
      
      private var var_1428:Number = 1;
      
      private var var_1975:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1428,var_1430,var_1427,_alphaMultiplier);
         var_971 = generatePaletteMapForGrayscale(var_1976,var_1977);
      }
      
      public function get reds() : Array
      {
         return var_971.getValue("reds") as Array;
      }
      ...
      {
         return var_971.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_971.getValue("greens") as Array;
      }
      ...
      {
         return var_971.getValue("alphas") as Array;
      }
