   ...
   public class GroupDetailsView
   {
      ...
      private function openExternalLink(param1:String) : void
      {
         if(param1 != "")
         {
            ...
            HabboWebTools.openWebPage(param1,"_empty");
         }
      }
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(var_149 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_149 = _sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_325,HabboWindowStyle.const_38,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
      ...
      private function onGroupDetailsEvents(param1:Event) : void
      {
         ...
         var _loc3_:HabboGroupDetails = _sessionManager.getGroupDetails(var_1653);
         switch(_loc2_.name)
         {
