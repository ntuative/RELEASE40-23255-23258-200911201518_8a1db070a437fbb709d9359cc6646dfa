package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         return var_355.getValue(param1);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = var_584.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         var_584.remove(param1);
         var_584.add(param1,param2);
      }
      
      public function setUserData(param1:IUserData) : void
      {
         var_355.remove(param1.webID);
         _userIds.remove(param1.id);
         var_355.add(param1.webID,param1);
