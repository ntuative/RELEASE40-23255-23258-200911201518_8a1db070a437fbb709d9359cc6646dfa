package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_949:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_275 && _connection != null)
         {
            _state = RoomSessionEvent.const_85;
            if(isPrivateRoom)
            {
               return sendOpenFlatConnectionMessage();
            }
            return method_6(_roomId,0,true);
         }
         return false;
      }
      ...
      private function method_6(param1:int, param2:int, param3:Boolean) : Boolean
      {
         if(_connection == null)
         {
            return false;
      ...
      public function method_17(param1:String) : void
      {
      ...
      {
         return var_949 as IUserDataManager;
      }
