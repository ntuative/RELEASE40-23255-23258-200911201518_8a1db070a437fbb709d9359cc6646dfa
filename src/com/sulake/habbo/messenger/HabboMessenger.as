package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_509:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_508:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_853,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_509.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_509.setSelected(_loc2_);
            var_508.openMessenger();
            var_508.refresh(true);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_177.getKey("url.prefix",_loc2_);
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         return _loc2_.getImage(AvatarSetType.const_43);
      }
      ...
      {
         var_509.addMessageAndUpdateView(param1);
         if(!var_508.isMessengerOpen())
         {
      ...
      {
         var_509 = new Conversations(new ConversationsDeps(this));
         var_508 = new MessengerView(this);
      ...
      {
         var_509.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         ...
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_530,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_509.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_868,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_509.addMessageAndUpdateView(_loc3_);
      }
