package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1017:int = 10;
      
      private static const const_1018:int = 20;
      
      private static const const_737:int = 100;
       
      
      private var var_1763:IScrollbarWindow;
      
      private var var_132:HabboMessenger;
      
      private var var_1354:IContainerButtonWindow;
      
      private var var_442:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_132 = param1;
         var_1354 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1763 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_132.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      {
         if(param1 == Message.const_577)
         {
            return 4285887861;
         }
         if(param1 == Message.const_657)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_132.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_617 || param3.type == Message.const_530 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_442.messages.length - const_737);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_442.messages.length)
         {
            refreshEntry(true,_loc1_,var_442.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc1_:Conversation = var_132.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(var_442 == null || _loc1_.id != var_442.id)
         {
            var_442 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_737 + const_1018)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_132.conversations.closeConversation();
         var_132.messengerView.refresh(true);
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_132.send(new FollowFriendMessageComposer(var_442.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_132.getButtonImage(param1);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_132.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_132.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1017;
         param1.invalidate();
      }
   }
}
