package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(_loc13_ != null)
         {
            var_351 = new Rectangle(0,0,int(_loc13_.attribute("width")),int(_loc13_.attribute("height")));
            var_59 = var_351.clone();
            var_22 = var_351.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_120,WindowParam.const_134);
         var _loc2_:* = !testParamFlag(WindowParam.const_103,WindowParam.const_131);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_147)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_31 & 0);
               if(_loc5_ == WindowParam.const_217)
               {
      ...
      {
         var_5 = param1;
         var_415 = !!var_5 ? uint(var_415 | _alphaColor) : uint(var_415 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_69);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_461)
         {
            return true;
         }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1938 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_948:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1284:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1233:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_299:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_654:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_425:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_673:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_256:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_449:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_385:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_266:
               _loc2_ = "null";
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_86 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_351,this,null));
         }
      }
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_773;
         update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_948;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_392 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_22,WindowRedrawFlag.const_944);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_963 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_271,this,param1));
         return param1;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_415 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_69);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_621))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_784;
                  ...
                  if((var_31 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_257))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_257))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_227:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_385,this,null));
                     if(testParamFlag(WindowParam.const_147,WindowParam.const_134))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_165,WindowParam.const_131))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_266,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_440:
                  _context.invalidate(this,var_22.union(var_59),WindowRedrawFlag.const_454);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_840,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_302:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_673,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_182,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_379:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_790);
                  break;
               case WindowNotifyEvent.const_351:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_425:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_454);
                     }
                  }
                  else if(var_31 & 0)
                  {
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_302;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_587;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_963 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_358)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_365)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_797,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_540,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1119,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_60,true);
         _loc1_.type = WindowNotifyEvent.const_1116;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_305 && var_489 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1420,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1420,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               ...
               var_59.width = var_22.width;
               var_59.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_449,this,var_23));
            }
            else
            {
               var_293.x = 0;
               ...
               var_293.width = 0;
               var_293.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_835,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_238,_type,var_86,var_31,_context,var_22,null,var_572,properties,var_573.concat(),_id) as WindowController;
         _loc2_.var_489 = var_489;
         _loc2_.var_305 = var_305;
         _loc2_.var_859 = var_859;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_546;
         update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_822,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
