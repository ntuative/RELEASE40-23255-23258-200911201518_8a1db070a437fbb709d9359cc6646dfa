package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1409:String = "_INCLUDE";
      
      public static const const_875:String = "_EXCLUDE";
      
      public static const const_1405:String = "_TEMP";
      
      private static const const_1057:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1058:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1030:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_860:Dictionary;
      
      protected var var_1281:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1282:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1031,var_1030);
         var_860 = new Dictionary();
         var_1282 = new Dictionary();
         ParamCodeTable.fillTables(var_860,var_1282);
         var_1281 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1058,"");
         return param1.replace(const_1057,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1030)
            {
               delete var_1030[_loc1_];
            }
            for(_loc1_ in var_860)
            {
               delete var_860[_loc1_];
            }
            for(_loc1_ in var_1282)
            {
               delete var_1282[_loc1_];
            }
            var_1281.dispose();
            var_1281 = null;
            _context = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_147)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_875) == -1)
                  {
