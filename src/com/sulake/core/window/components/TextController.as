package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2201:Rectangle = new Rectangle();
      ...
      protected var var_487:String = "none";
      ...
      {
         return new Rectangle(var_571 * maxScrollH,var_347 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_686)
         {
            context.removeLocalizationListener(var_238,this);
         }
         if(var_71 != null)
         {
            var_71.dispose();
      ...
      {
         var_571 = param1;
         _field.scrollH = var_571 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_238 = param1;
         if(var_238.charAt(0) == "$" && var_238.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_238.slice(2,var_238.indexOf("}")),this);
            var_686 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_242,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1097,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_419,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_242,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_419,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_242,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_622,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_242,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_622,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_71.left,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_top",var_71.top,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_right",var_71.right,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_71.bottom,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("auto_size",var_487,PropertyStruct.const_242,var_487 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_622,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_487 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_487 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_487 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_487 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
