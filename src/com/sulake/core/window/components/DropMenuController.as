package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_142:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_142 == null || false)
         {
            var_142 = context.create(name + "::submenu","",WindowType.const_369,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
            var_142.setGlobalRectangle(_loc1_);
         }
         var_142.activate();
         return var_142;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_775)
         {
            if(param2 == var_142)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_343,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_292,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_477 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_477).setStateFlag(WindowState.const_48,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_565)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_478,getSubMenu(),subMenuEventProc);
                  var_565 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_387,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_477 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_299,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_142 != null)
            {
               _loc2_ = var_142.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_565 = false;
            getTitleText().text = var_477 < var_478.length && var_477 > -1 ? "null" : caption;
         }
      }
   }
}
