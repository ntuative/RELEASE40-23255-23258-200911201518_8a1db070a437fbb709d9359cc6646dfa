package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      protected var var_414:Boolean = true;
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_414 = var_414;
         _loc1_.var_1032 = var_1032;
         return _loc1_;
      }
      
      public function set bitmap(param1:BitmapData) : void
      {
         if(var_414 && _bitmapData && param1 != _bitmapData)
         {
            _bitmapData.dispose();
         }
         _bitmapData = param1;
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               case "handle_bitmap_disposing":
                  var_414 = _loc3_.value as Boolean;
                  break;
               case "bitmap_asset_name":
                  var_1032 = _loc3_.value as String;
                  break;
            }
            _loc4_++;
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_414,PropertyStruct.const_61,var_414 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1032,PropertyStruct.const_242,var_1032 != null));
         return _loc1_;
      }
