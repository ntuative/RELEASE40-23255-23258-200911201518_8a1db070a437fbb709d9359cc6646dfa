package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1471:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_343)
         {
            ...
            if(var_343)
            {
               var_343.addEventListener(WindowEvent.const_259,scrollBarEventProc);
               var_343.addEventListener(WindowEvent.const_185,scrollBarEventProc);
            }
         }
         return var_343;
      }
      ...
      override public function dispose() : void
      {
         if(var_343)
         {
            var_343.removeEventListener(WindowEvent.const_259,scrollBarEventProc);
            var_343.removeEventListener(WindowEvent.const_185,scrollBarEventProc);
            var_343 = null;
         }
         if(_cachedItemList)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_185)
         {
            hideScrollBar();
         }
      }
