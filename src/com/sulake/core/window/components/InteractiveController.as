package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_858:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_409 = new Array();
         var_409[0] = MouseCursorType.const_323;
         var_409[1] = MouseCursorType.const_38;
         var_409[2] = MouseCursorType.const_323;
         var_409[3] = MouseCursorType.const_323;
         var_409[4] = MouseCursorType.const_38;
         var_409[5] = MouseCursorType.const_38;
         var_409[6] = MouseCursorType.const_323;
         if(var_307 == null)
         {
            var_307 = new Array();
            var_307[0] = WindowState.const_81;
            var_307[1] = WindowState.const_71;
            var_307[2] = WindowState.const_73;
            var_307[3] = WindowState.const_60;
            var_307[4] = WindowState.const_48;
