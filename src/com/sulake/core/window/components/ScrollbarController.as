package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_990:String = "increment";
      
      private static const const_475:String = "slider_bar";
      
      private static const const_989:String = "decrement";
      
      private static const const_727:String = "slider_track";
      ...
      protected var var_1500:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0, param13:IScrollableWindow = null)
      {
         ...
         var_35 = param13;
         _horizontal = param3 == WindowType.const_380;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_449)
         {
            if(var_35 == null)
            {
               resolveScrollTarget();
      ...
      {
         return getChildByName(ScrollbarController.const_727) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_35 != null && true)
         {
            IWindow(var_35).removeEventListener(WindowEvent.const_47,onScrollableResized);
         }
         var_35 = param1;
         if(var_35 != null && true)
         {
            IWindow(var_35).addEventListener(WindowEvent.const_47,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_711 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_711 != null)
         {
            _loc1_ = findParentByName(var_711) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_711) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_990)
            {
               if(var_35)
               {
                  var_503 = true;
            ...
            else if(param2.name == ScrollbarController.const_989)
            {
               if(var_35)
               {
                  var_503 = true;
            ...
            else if(param2.name == ScrollbarController.const_727)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_827)
         {
