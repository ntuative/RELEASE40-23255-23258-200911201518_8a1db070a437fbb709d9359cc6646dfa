package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1365:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_522 = new Array();
         var_1366 = new Point();
         var_1365 = new Rectangle();
         var_287 = new Rectangle();
         var_286 = new Dictionary(true);
         var_663 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_286[param1] as WindowRendererItem;
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_706,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_286[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1366,var_1365))
            {
               if(param2.render(param1,var_1366,var_1365))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_663);
            var_286[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_706,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_287,WindowRedrawFlag.const_265);
