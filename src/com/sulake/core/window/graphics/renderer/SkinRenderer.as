package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_302)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_302[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_303[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_411[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_303[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_302[param1] = _loc3_;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_411)
         {
            ISkinLayout(var_411[_loc1_]).dispose();
            delete var_411[_loc1_];
         }
         var_411 = null;
         _layoutsByState = null;
         for(_loc1_ in var_303)
         {
            ISkinTemplate(var_303[_loc1_]).dispose();
            delete var_303[_loc1_];
         }
         var_303 = null;
         var_302 = null;
      }
