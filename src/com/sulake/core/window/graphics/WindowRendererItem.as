package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_759:uint = 2;
       
      
      private var var_663:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_454:
               ...
               break;
            case WindowRedrawFlag.const_790:
               var_664 = var_663.getTheActualState(param1.type,param1.style,param1.state);
               if(var_664 != var_984)
               {
                  var_227 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_944:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  var_227 = true;
                  _loc4_ = true;
      ...
      {
         return var_663.getTheActualState(param1.type,param1.style,param1.state) != var_984;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_759) : uint(const_486);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_664) ? uint(const_758) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_758)
               {
                  ...
                  if(var_227)
                  {
                     ...
                     _loc6_.draw(param1,var_97,var_97.rect,var_664,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_97,var_851,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_663.method_10(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_803)
            {
               _loc2_ = var_663.method_10(param1.type,WindowStyle.const_803);
            }
         }
         return _loc2_;
      }
