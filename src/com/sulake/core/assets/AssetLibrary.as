package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_904:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_516:uint = 0;
      
      public static const const_1245:String = "AssetLibraryReady";
      
      public static const const_1290:String = "AssetLibraryUnloaded";
      
      public static const const_406:String = "AssetLibraryLoaded";
      
      public static const const_1144:String = "AssetLibraryLoadError";
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_368)
         {
            _loc4_ = AssetTypeDeclaration(var_368[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         var_283 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1290));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_314 = _loc2_.resource;
         if(var_437)
         {
            AssetLibrary.fetchLibraryContents(this,var_438,var_314);
         }
         var_283 = true;
         dispatchEvent(new Event(AssetLibrary.const_406));
         if(var_437)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_46,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_882,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_787,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_930,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_771,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_368.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_368[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_904.splice(var_904.indexOf(this),1);
            --var_516;
            var_369 = null;
            var_608 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_313.length ? getAssetByName(var_313[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1144));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_368)
         {
            _loc3_ = AssetTypeDeclaration(var_368[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_608[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         if(_file == param1.url && var_283)
         {
            ...
            var_437 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1245));
         }
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_859);
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_314[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_313.splice(var_313.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_368[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_314 != null ? false : false;
      }
   }
}
