package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_718))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_718,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_98 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_718,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_476.parse(param1))
         {
            ...
            if(false)
            {
               var_141["null"] = var_476;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1300,var_476));
            var_476 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_52 != null && var_141 != null && param1 < var_52.length)
         {
